...
#
# ZDS II Make File - lab5_1 project, Debug configuration
#
...
LDFLAGS = @.\lab5_1_Debug.linkcmd
OUTDIR = Z:\Dropbox\GITH~927\PROG~835\Debug

build: lab5_1

buildall: clean lab5_1

relink: deltarget lab5_1

deltarget: 
	@if exist $(WORKDIR)\lab5_1.lod  \
            $(RM) $(WORKDIR)\lab5_1.lod
	@if exist $(WORKDIR)\lab5_1.hex  \
            $(RM) $(WORKDIR)\lab5_1.hex
	@if exist $(WORKDIR)\lab5_1.map  \
            $(RM) $(WORKDIR)\lab5_1.map
...
clean: 
	...
	@if exist $(WORKDIR)\lab5_1.map  \
            $(RM) $(WORKDIR)\lab5_1.map
	@if exist $(WORKDIR)\lab5_1.obj  \
            $(RM) $(WORKDIR)\lab5_1.obj
...
$(WORKDIR)\lab5_1.obj :  \
            Z:\Dropbox\GITH~927\PROG~835\lab5_1.c  \
	 ...
	 $(CC) $(CFLAGS) Z:\Dropbox\GITH~927\PROG~835\lab5_1.c
