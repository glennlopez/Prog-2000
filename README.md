...
It's your choice to use these resources I am providing as reference or for cheating. Maybe when learning is not commensurately represented by grades, you'll realize how pointless it is to say you learned something, when you clearly havn't. If you are going to cheat, atleast be creative about it. Keep in mind that grades are only a currency and sole commodity of schools. In real life, your grades are worthless. Sometimes you have to find ways to cheat the system in order to solve a problem in the most efficient way without commiting a felony (this is what you are payed to do), and people who blindly follow the rules are the same sets of people who don't think for themselfs-- these are the people who will fail to inovate and make a difference in the company they are working for. These are the people who belong in government jobs with uninions that protect the weak.. the ones with no aspirations, too lazy to make a diffrence in society.
