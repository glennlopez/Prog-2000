What is Prog-2000
-----------------
><b>For prospective employers:</b> A lot of the code I wrote for Prog-2000 are old/un-revised. As such, you may see a lot of bad coding habits. For more recent materials, do visit https://github.com/glennlopez/EmbeddedSystems.Playground. My EmbeddedSystems.Playground repo is where I keep the more modern micro controllers I play with (ie:Texas Instruments TMC4 using <u>Arm's Cortex M4</u> architechture).
